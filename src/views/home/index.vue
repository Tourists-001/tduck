<template>
  <div>
    <el-container class="home-container">
          ...
          <el-popover placement="bottom" trigger="click" width="50">
            <div class="user-person-menu">
              ...
              <div>
                ...
                <el-divider />
                <p class="person-menu-item" @click="logotHandle">
            ...
            <div slot="reference">
              <img
                v-if="getUserInfo"
                :src="getUserInfo.avatar || '@/assets/avatar.jpg'"
                class="user-avatar"
              >
            </div>
          </el-popover>
      ...
      <el-container class="centent-container">
        ...
        <el-container class="scsroll-container">
              ...
              <el-footer>
                <div class="about-container">
                  <span class="desc-text">
                    <a href="https://www.tduckcloud.com" target="view_window">
                      TDUCK官网
                    </a>
                  </span>
                </div>
...
import { createFormRequest } from '@/api/project/form.js'
export default {
  name: 'NewIndex',
  data() {
    return {
  ...
  computed: {
    ...
    getUserInfo() {
      const user = JSON.parse(this.getStore.getters['user/userInfo'])
      return user
    }
  },
  created() {
...
.user-person-menu ::v-deep .el-divider--horizontal {
